...
// Reusing the same tab makes sense only if the provided URL is the specific chat
// if the provided URL leads to GPT, the chat URL will be automatically created by ChatGPT app and set into the browser URL.
